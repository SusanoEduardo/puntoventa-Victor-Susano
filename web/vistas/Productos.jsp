                            ...
                            out.print("<div class='col-sm-8 col-md-6'>"
                                        ...
                                        + "<h3> Editar productos </h3>"
                                            + "<form method='POST' action='SRProductos'>"
                                                ...
                                                + "</div>"
                                                + "<div class='mb-3'>"
                                                    + "<input class='form-control' type='text' placeholder='' name='tfDescripcion' value='"+ producto.getDescripcion()+"'>"
                                                + "</div>"
                                                + "<div class='mb-3'>"
                                                  + "<input class='form-control' type='text' placeholder='Precio' name='tfCantidad' value='" + producto.getCantidad() + "'>"
                                                + "</div>"
                                                + "<div class='mb-3'>"
