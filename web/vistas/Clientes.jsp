                            ...
                            out.print("<div class='col-sm-8 col-md-6'>"
                                        ...
                                        + "<h3> Editar Clientes </h3>"
                                            + "<form method='POST' action='SClientes'>"
                                                ...
                                                + "</div>"
                                                + "<div class='mb-3'>"
                                                    + "<input class='form-control' type='text' placeholder='ApellidoP' name='tfApellidoP' value='"+ cliente.getApellidoP()+"'>"
                                                + "</div>"
                                                + "<div class='mb-3'>"
                                                  + "<input class='form-control' type='text' placeholder='Precio' name='tfApellidoM' value='" + cliente.getApellidoM() + "'>"
                                                + "</div>"
                                                + "<div class='mb-3'>"
                                                  + "<input class='form-control' type='text' placeholder='Precio' name='tfDirec' value='" + cliente.getDireccion() + "'>"
                                                + "</div>"
                                                + "<div class='mb-3'>"
                                                    + "<input class='form-control' type='text' placeholder='Precio' name='tfTel' value='" + cliente.getTelefono() + "'>"
                                                + "</div>"
                                                + "<div class='p-t-20'>"
